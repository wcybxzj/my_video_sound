...
int main(int argc, char* argv[])
{
	...
	char filepath[]="/root/www/video_sound_data/5.flv_data/408.mkv";
	...
	//4.因为输入的不是文件，而是直接去读取内存
	//avformat_open_input()不指定filename
