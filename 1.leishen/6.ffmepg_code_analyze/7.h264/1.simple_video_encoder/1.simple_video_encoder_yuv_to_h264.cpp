...
唯一的不同在于不再输入视频像素数据。它的作用在于输出编码器中剩余的码流数据。
*/
int main(int argc, char** argv)
{
	...
	FILE* fp_src  = fopen("/root/www/video_sound_data/1.yuv_data/sintel_480x272_yuv420p.yuv", "rb");
	FILE* fp_dst = fopen("480x272.h264", "wb");
