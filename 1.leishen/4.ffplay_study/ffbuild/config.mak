...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-libx264 --enable-libx265 --enable-libmp3lame --enable-gpl --extra-cflags=-I/usr/local/include --extra-ldflags=-L/usr/local/lib --enable-libfdk-aac --enable-nonfree
prefix=/usr/local
...
CC_IDENT=gcc 4.4.7 (GCC) 20120313 (Red Hat 4.4.7-11)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=  -I/usr/local/include -std=c99 -fomit-frame-pointer -pthread -I/usr/local/include -I/usr/local/include -I/usr/local/include -D_REENTRANT -I/usr/local/include/SDL2  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat
...
EXTRALIBS=-lXv -lX11 -lXext -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -L/usr/local/lib -lSDL2 -ldl -ldl -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -L/usr/local/lib -lSDL2 -liconv -lxcb -lxcb-shm -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lasound -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -L/usr/local/lib -lSDL2 -L/usr/local/lib -lx265 -L/usr/local/lib -lx264 -lmp3lame -L/usr/local/lib -lfdk-aac -lm -llzma -lbz2 -lz -pthread -pthread -lrt 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
