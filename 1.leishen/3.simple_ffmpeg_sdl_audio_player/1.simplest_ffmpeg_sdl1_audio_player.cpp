...
int main(int argc, char* argv[])
{
	...
	//char url[]="72bian.wma";
	char url[]="/root/www/video_sound_data/4.aac_data/1.aac";
	//char url[]="/root/www/video_sound_data/4.aac_data/WavinFlag.aac";
	...
	//采样频率以及播放频率，就是说当时录MP3的时候，
	//每秒是以44100次采样录制的，而现在则以同样采样频率放出来
	...
	//而不再是AV_SAMPLE_FMT_S16（signed 16 bits）。
	//因此无法直接使用SDL进行播放。
	//最后的解决方法是使用SwrContext对音频采样数据进行转换
